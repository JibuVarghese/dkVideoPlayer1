...
public class FullScreenActivity extends BaseActivity<VideoView> {
    ...
    protected void initView() {
        ...
        VodControlView vodControlView = new VodControlView(this,10, new IVideoFinishingController() {
            @Override
            public void videoAboutToFinish(boolean currentVideoIsFinishing) {
                Toast.makeText(FullScreenActivity.this, "Video about to finish call back...." + currentVideoIsFinishing, Toast.LENGTH_SHORT).show();

            }

            @Override
            public void videoProgress(int playedPercentage) {
                Toast.makeText(FullScreenActivity.this,"Percentage : "+playedPercentage,Toast.LENGTH_SHORT).show();
            }
        });
